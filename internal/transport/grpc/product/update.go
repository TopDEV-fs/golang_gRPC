...
// UpdateProduct validates the request and delegates to the UpdateProduct use case.
...
// ActivateProduct transitions a product to ACTIVE status.
...
// DeactivateProduct transitions a product to INACTIVE status.
...
// ApplyDiscount applies a percentage discount to an active product.
...
// RemoveDiscount removes the active discount from a product.
